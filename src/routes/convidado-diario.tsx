...
function DiarioConvidado() {
  return (
    <GuestShell>
      <DiarioCalendario nomePaciente="José" />
    </GuestShell>
  );
}
        ...
        {temFotoSelecionada ? (
          <>
            <div className="overflow-hidden rounded-2xl bg-chrome-tint">
              <img src={fotoDia17} alt={`${nomePaciente} em seu registro diário de 17 de setembro de 2026`} className="max-h-80 w-full object-cover" />
            </div>
            <div className="mt-4">
              ...
              <p className="mt-4 text-base leading-relaxed text-inksoft">
                Registro fotográfico diário de {nomePaciente}. A família pode acompanhar a rotina e as atualizações compartilhadas pelo cuidador.
              </p>
            </div>
          </>
        ) : (
