...
function ConvitePage() {
  ...
  function continuar() {
    ...
    // Acesso de demonstração: não exige criar outra conta.
    // O código padrão leva diretamente às telas de convidado.
