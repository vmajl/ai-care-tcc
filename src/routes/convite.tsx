...
function ConvitePage() {
  ...
  function continuar() {
    ...
    // Usa a navegação do navegador para garantir que o AuthPage
    // seja montado novamente já com o modo convidado e o código.
    window.location.href = `/auth?modo=convidado&codigo=${encodeURIComponent(normalizado)}`;
  }
