...
function ConvitePage() {
  ...
  return <div className="min-h-screen bg-canvas font-body text-ink"><main className="mx-auto max-w-[460px] space-y-6 px-5 py-8">
    ...
    <section className="flex items-start gap-3 rounded-xl bg-chrome-tint p-4 ring-1 ring-border"><Users className="mt-0.5 size-6 shrink-0 text-chrome-deep" /><p className="text-sm text-inksoft">O código define o tipo de acesso recebido. Depois de criar sua conta, o AICare aplica automaticamente a permissão do convite.</p></section>
  </main></div>;
}
